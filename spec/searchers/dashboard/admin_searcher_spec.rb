...
describe Dashboard::AdminSearcher do
  ...
  before(:each) do
    ...
    create :user, :moderator, organization: test_organization
    ...
    create :user, :moderator, organization: archive_organization

    organization = create :organization
    create :user, :moderator, organization: organization
    create :user, :moderator, organization: organization
    ...
    15.times do |i|
      hr = create :help_request, organization: organization
    ...
    7.times do
      hr = create :help_request, organization: organization, created_at: past_time
    ...
    3.times do
      hr = create :help_request, organization: test_organization
    ...
    2.times do
      hr = create :help_request, organization: archive_organization
